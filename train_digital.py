...
def train_cnn():
    ...
    train_file = "C:\\Users\\S3134076\\Desktop\\higher\\training_data\\digital_training_data.zip"
    x_raw, y_raw, df, labels = data_helper.load_data_and_labels(train_file)

    parameter_file = "C:\\Users\\S3134076\\PycharmProjects\\nps\\parameters_digital.json"
    ...
    with open('./labels_digital.json', 'w') as outfile:
    ...
    for num_epoch in [25]:
        ...
        for batch_size in [30]:
            ...
            for l2 in [0.0]:
                params['l2_reg_lambda'] = params['l2_reg_lambda']
                ...
                with graph.as_default():
                    ...
                    with sess.as_default():
                        ...
                        vocab_processor.save(os.path.join(out_dir, "vocab_digital.pickle"))
                        ...
                        for train_batch in train_batches:
                            ...
                            if current_step % params['evaluate_every'] == 0:
                                ...
                                for dev_batch in dev_batches:
                                    ...
                                    num_dev_correct = dev_step(x_dev_batch, y_dev_batch, writer=dev_summary_writer)
                        ...
                        logging.critical(
                            'Accuracy on test set is {} based on the best model {}'.format(test_accuracy, path))
                        logging.critical('The training is complete')
if __name__ == '__main__':
    # python3 train.py ./data/consumer_complaints.csv.zip ./parameters_complaints.json
    train_cnn()
